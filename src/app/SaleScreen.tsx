 ...
 */
function isPassItem(item: CartItem): boolean {
  /* A T95 gift card is not a pass: it is a bearer instrument that needs
   * no owner, which is why T92's rule does not reach it (and why the
   * checkout refuses a gift card beside a line bought for someone
   * else). CartItem, not ShelfItem, so a cart line can be asked. */
